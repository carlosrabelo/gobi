...
- [ ] Project layout setup (cmd, internal, pkg structure)
- [ ] Root Makefile with test, lint, format and build targets
- [ ] Configuration struct for global environment variables
