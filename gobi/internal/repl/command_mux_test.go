...
func TestDispatchExactVerb(t *testing.T) {
	...
	err := commandMux.Dispatch(ctx, Command{Verb: "ERASE"})
	if err != nil {
		t.Fatalf("unexpected error: %v", err)
	}

	if stdout.Len() == 0 {
		t.Fatal("expected output from ERASE command")
	}
}
...
func TestDispatchAbbreviation(t *testing.T) {
	...
	err := commandMux.Dispatch(ctx, Command{Verb: "CLEA", RawVerb: "CLEA"})
	if err != nil {
		t.Fatalf("unexpected error: %v", err)
	}
}
...
func TestDispatchAmbiguousVerb(t *testing.T) {
	// "DI" is prefix of both DIR and DISPLAY
	ctx := testCtx()

	err := commandMux.Dispatch(ctx, Command{Verb: "DI"})
	if err == nil {
		t.Fatal("expected error for ambiguous verb")
	}
	if !strings.Contains(err.Error(), "Unrecognized command") {
		t.Fatalf("expected unrecognized command error, got %v", err)
	}
...
func TestDispatchSetTalkOff(t *testing.T) {
	ctx := testCtx()
	ctx.Stdout = &bytes.Buffer{}

	err := commandMux.Dispatch(ctx, Command{Verb: "SET", Args: "TALK OFF"})
	if err != nil {
		t.Fatalf("unexpected error: %v", err)
	}
	if ctx.Config.Talk {
...
func TestDispatchSetTalkOn(t *testing.T) {
	ctx := testCtx()
	ctx.Config.Talk = false
	ctx.Stdout = &bytes.Buffer{}

	err := commandMux.Dispatch(ctx, Command{Verb: "SET", Args: "TALK ON"})
	if err != nil {
		t.Fatalf("unexpected error: %v", err)
	}
	if !ctx.Config.Talk {
...
func TestDispatchSetBell(t *testing.T) {
	ctx := testCtx()
	ctx.Stdout = &bytes.Buffer{}

	err := commandMux.Dispatch(ctx, Command{Verb: "SET", Args: "BELL OFF"})
	if err != nil {
		t.Fatalf("unexpected error: %v", err)
	}
	if ctx.Config.Bell {
...
func TestDispatchSetIntensity(t *testing.T) {
	ctx := testCtx()
	ctx.Stdout = &bytes.Buffer{}

	err := commandMux.Dispatch(ctx, Command{Verb: "SET", Args: "INTENSITY OFF"})
	if err != nil {
		t.Fatalf("unexpected error: %v", err)
	}
...
func TestDispatchSetDefault(t *testing.T) {
	...
	err := commandMux.Dispatch(ctx, Command{Verb: "SET", Args: "DEFAULT TO /tmp"})
	if err != nil {
		t.Fatalf("unexpected error: %v", err)
	}
	if ctx.Config.DefaultDir != "/tmp" {
		t.Fatalf("expected /tmp, got %s", ctx.Config.DefaultDir)
	}
}

func TestDispatchSetNoArgs(t *testing.T) {
	ctx := testCtx()

	err := commandMux.Dispatch(ctx, Command{Verb: "SET"})
	if err == nil {
...
func TestDispatchDisplayPagination(t *testing.T) {
	...
	stdout.Reset()
	if err := commandMux.Dispatch(ctx, Command{Verb: "?", Args: "EOF()"}); err != nil {
		t.Fatalf("unexpected error evaluating EOF(): %v", err)
	}
	if stdout.String() != ".F.\n" {
		t.Fatalf("expected EOF()=.F. on last record, got %q", stdout.String())
	}
}
...
func TestDispatchAppendRequiresFrom(t *testing.T) {
	...
	err := commandMux.Dispatch(ctx, Command{Verb: "APPEND", Args: "SDF"})
	if err == nil || !strings.Contains(err.Error(), "APPEND requires FROM") {
		t.Fatalf("expected APPEND requires FROM error, got %v", err)
	}
}
...
func TestDispatchLocateAndContinue(t *testing.T) {
	...
	var stdout bytes.Buffer
	ctx.Stdout = &stdout
	if err := commandMux.Dispatch(ctx, Command{Verb: "?", Args: "FOUND()"}); err != nil {
		t.Fatalf("unexpected error evaluating FOUND(): %v", err)
	}
	if !strings.Contains(stdout.String(), ".F.") {
		t.Fatalf("expected FOUND() false after failed search, got %q", stdout.String())
	}
}
...
func TestDispatchCountToVariable(t *testing.T) {
	...
	stdout.Reset()
	if err := commandMux.Dispatch(ctx, Command{Verb: "?", Args: "ADULTS"}); err != nil {
		t.Fatalf("unexpected error evaluating ADULTS: %v", err)
	}
	if !strings.Contains(stdout.String(), "3") {
		t.Fatalf("expected ADULTS value in output, got %q", stdout.String())
	}
}
...
func TestDispatchReplaceExpression(t *testing.T) {
	...
	var stdout bytes.Buffer
	ctx.Stdout = &stdout
	if err := commandMux.Dispatch(ctx, Command{Verb: "?", Args: "NAME"}); err != nil {
		t.Fatalf("unexpected error evaluating NAME: %v", err)
	}
	if stdout.String() != "CHARLIE\n" {
		t.Fatalf("expected NAME=CHARLIE, got %q", stdout.String())
	}
}
...
func TestDispatchDeleteCurrentRecord(t *testing.T) {
	...
	stdout.Reset()
	if err := commandMux.Dispatch(ctx, Command{Verb: "?", Args: "DELETED()"}); err != nil {
		t.Fatalf("unexpected error evaluating DELETED(): %v", err)
	}
	if stdout.String() != ".T.\n" {
		t.Fatalf("expected DELETED()=.T., got %q", stdout.String())
	}
}
...
func TestDispatchRecallCurrentRecord(t *testing.T) {
	...
	if stdout.String() != ".F.\n" {
		t.Fatalf("expected DELETED()=.F., got %q", stdout.String())
	}
}
...
func TestDispatchModifyStructureAddField(t *testing.T) {
	...
	ctx := testCtx()
	ctx.Stdin = strings.NewReader("\t\tPHONE,C,10,0\x17")
	ctx.Stdout = &bytes.Buffer{}
...
func TestDispatchModifyStructureAbort(t *testing.T) {
	tempDir := t.TempDir()
	dbfPath := createTempDBFWithRecords(t, tempDir, "moddb.dbf", nil)

	ctx := testCtx()
	ctx.Stdin = strings.NewReader("\x19BADNAME,C,10,0\x11")
	ctx.Stdout = &bytes.Buffer{}
	...
	if area.Table.Fields[0].Name != "NAME" {
		t.Fatalf("expected original field NAME, got %s", area.Table.Fields[0].Name)
	}
}
...
func TestDispatchGoto(t *testing.T) {
	...
	stdout.Reset()
	if err := commandMux.Dispatch(ctx, Command{Verb: "?", Args: "RECNO()"}); err != nil {
		t.Fatalf("unexpected error evaluating RECNO(): %v", err)
	}
	if stdout.String() != "2\n" {
		t.Fatalf("expected RECNO()=2, got %q", stdout.String())
	}
	...
	if stdout.String() != ".T.\n" {
		t.Fatalf("expected EOF()=.T., got %q", stdout.String())
	}
...
func TestDispatchGoTopAndBottom(t *testing.T) {
	...
	if stdout.String() != "1\n" {
		t.Fatalf("expected RECNO()=1 after GO TOP, got %q", stdout.String())
	}
	...
	if !strings.Contains(stdout.String(), "Alice") {
		t.Fatalf("expected NAME=Alice after GO TOP, got %q", stdout.String())
	}
	...
	if stdout.String() != "3\n" {
		t.Fatalf("expected RECNO()=3 after GO BOTTOM, got %q", stdout.String())
	}
	...
	if !strings.Contains(stdout.String(), "Charlie") {
		t.Fatalf("expected NAME=Charlie after GO BOTTOM, got %q", stdout.String())
	}
	...
	if stdout.String() != ".F.\n" {
		t.Fatalf("expected EOF()=.F. after GO BOTTOM, got %q", stdout.String())
	}
}
...
func TestDispatchGoTopEmptyDatabase(t *testing.T) {
	...
	if stdout.String() != ".T.\n" {
		t.Fatalf("expected EOF()=.T. on empty table, got %q", stdout.String())
	}
}
...
func TestDispatchSkip(t *testing.T) {
	...
	if !strings.Contains(stdout.String(), "Bob") {
		t.Fatalf("expected NAME=Bob after SKIP, got %q", stdout.String())
	}
	...
	if stdout.String() != "1\n" {
		t.Fatalf("expected RECNO()=1, got %q", stdout.String())
	}
	...
	if stdout.String() != ".T.\n" {
		t.Fatalf("expected EOF()=.T. after SKIP past end, got %q", stdout.String())
	}
...
func TestCommandsList(t *testing.T) {
	...
	if !found {
		t.Fatal("expected CLEAR in command list")
	}
}
...
func TestResolveVerb(t *testing.T) {
	...
	tests := []struct {
		...
		{"DISP", "DISPLAY", true},
		{"DIR", "DIR", true},
		{"DI", "", false}, // ambiguous: DIR and DISPLAY
		{"D", "", false},  // ambiguous: DIR and DISPLAY
		{"XYZZY", "", false},
	}

	for _, tt := range tests {
		got, ok := resolveVerb(tt.input, handlers)
		if ok != tt.ok {
			t.Errorf("resolveVerb(%q): got ok=%v, want %v", tt.input, ok, tt.ok)
		}
		if ok && got != tt.want {
			t.Errorf("resolveVerb(%q): got %q, want %q", tt.input, got, tt.want)
		}
	}
}
...
func TestDispatchLowercaseVerb(t *testing.T) {
	...
	err := commandMux.Dispatch(ctx, Command{Verb: "clear"})
	if err != nil {
		t.Fatalf("unexpected error: %v", err)
	}
}

func TestDispatchAbbreviationMinimum(t *testing.T) {
	var stdout bytes.Buffer
	ctx := testCtx()
	ctx.Stdout = &stdout

	// "SELE" should resolve to "SELECT"
	err := commandMux.Dispatch(ctx, Command{Verb: "SELE", Args: "PRIMARY"})
	if err != nil {
		t.Fatalf("unexpected error: %v", err)
	}
	if ctx.ActiveArea != context.Primary {
		t.Fatal("expected PRIMARY area")
	}
}
...
func createTempDBF(t *testing.T, dir string, name string) string {
	path := filepath.Join(dir, name)
	// Minimal DBF header
	// Signature (0x02), 0 records (0x00, 0x00), Year/Month/Day (0x50, 0x06, 0x01),
	// Record length (21 bytes = 1 + 20) (0x15, 0x00)
	var buf []byte
	buf = append(buf, 0x02)             // Sig
	buf = append(buf, 0x00, 0x00)       // Count
	buf = append(buf, 0x50, 0x06, 0x01) // Date
	buf = append(buf, 0x15, 0x00)       // RecordLen (21 bytes)

	// Field descriptor: NAME (10 chars space padded + 1 null), Type (C), Length (20)
	fb := make([]byte, 16)
	copy(fb, "NAME")
	fb[10] = 'C'
	fb[11] = 20
...
func TestDispatchUse(t *testing.T) {
	...
	// 2. Close database by using empty USE
	...
	// 3. Open without extension (should append .dbf)
	err = commandMux.Dispatch(ctx, Command{Verb: "SET", Args: "DEFAULT TO " + tempDir})
	if err != nil {
		t.Fatalf("unexpected error setting default dir: %v", err)
	}

	err = commandMux.Dispatch(ctx, Command{Verb: "USE", Args: "testdb"})
	if err != nil {
		t.Fatalf("unexpected error: %v", err)
	}
	if activeArea.Table == nil {
		t.Fatal("expected table to be opened via SET DEFAULT and automatic .dbf suffix")
	}

	// 4. Try opening a non-existent file
	err = commandMux.Dispatch(ctx, Command{Verb: "USE", Args: "nonexistent"})
	if err == nil {
...
func TestDispatchList(t *testing.T) {
	...
	// Create test records
	// Each record has size: 1 (active flag) + 10 (NAME) + 3 (AGE) = 14 bytes
	// Deletion flags: rec1 = deleted (0x2A), rec2 = deleted (0x2A), rec3 = active (0x20)
	rec1 := append([]byte{0x2A}, append([]byte("Alice     "), []byte(" 25")...)...)
	rec2 := append([]byte{0x2A}, append([]byte("Bob       "), []byte(" 35")...)...)
	rec3 := append([]byte{0x20}, append([]byte("Charlie   "), []byte(" 45")...)...)
	...
	// 4. Test plain LIST (all fields, all records)
	stdout.Reset()
	err = commandMux.Dispatch(ctx, Command{Verb: "LIST"})
	if err != nil {
		t.Fatalf("unexpected error on LIST: %v", err)
	...
	// 5. Test LIST with field selection
	stdout.Reset()
	err = commandMux.Dispatch(ctx, Command{Verb: "LIST", Args: "NAME"})
	if err != nil {
		t.Fatalf("unexpected error: %v", err)
	...
	// 6. Test LIST with FOR filter (DELETED())
	stdout.Reset()
	...
	// 7. Test LIST with WHILE filter (DELETED())
	// Position cursor at record 1 (Bob, index 1)
	area := ctx.GetActiveArea()
	area.RecordNo = 1 // Bob
	...
	// 8. Test LIST TO <file> (redirection)
